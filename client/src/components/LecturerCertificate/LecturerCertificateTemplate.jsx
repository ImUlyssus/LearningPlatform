// src/components/CertificateTemplate/LecturerCertificateTemplate.jsx
...
const LecturerCertificateTemplate = ({ lecturerName, subCourseTitle, dateOfAppreciation, mapId }) => {
    const ORG_NAME = WEBSITE_NAME_LOWER;
    const ORG_LOGO_SRC = "https://via.placeholder.com/100x40?text=FORD+LOGO"; // Consider updating this to an actual logo
    ...
    const VERIFICATION_URL = `https://www.${WEBSITE_NAME_LOWER}.com/lecturer-certificate/${mapId}`; // Assuming this is the verification path
        ...
        <div className="bg-white border-4 border-[#D1F2EE] shadow-xl rounded-lg overflow-hidden w-full h-full flex flex-col font-sans">
            ...
            <div className="bg-[#2B4468] text-white p-2 md:p-4 flex flex-col sm:flex-row justify-between items-start gap-2">
                <div className="flex-grow text-left min-w-0">
                    ...
                    <p className="text-xs md:text-sm lg:text-md mt-1 leading-tight">Certificate of Appreciation</p>
                </div>
            </div>
            ...
            <div className="flex-grow p-2 md:p-4 flex flex-col justify-center items-start text-left">
                <p className="text-[#374151] text-[10px] md:text-xs mb-1 md:mb-2">This Certificate of Appreciation is proudly presented to</p>
...
export default LecturerCertificateTemplate;
